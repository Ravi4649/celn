...
data = np.load('/home/ravizin/celn-v3/celn_v3_limpo_svd_vectors.npz', allow_pickle=True)
...
sentences = load_corpus('/home/ravizin/celn-v3/corpus_pt_limpo.txt', min_len=1)
